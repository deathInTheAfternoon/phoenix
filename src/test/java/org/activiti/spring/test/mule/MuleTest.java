...
package org.activiti.spring.test.mule;
 ...
 */
 ...
 //@ContextConfiguration("classpath:org/activiti/spring/test/mule/mule-configuration.xml")
...
*/
  ...
  public void testMuleProcess() {
    try
    {
      MuleContext muleContext = new DefaultMuleContextFactory().createMuleContext("org/activiti/spring/test/mule/mule-configuration.xml");
      muleContext.start();

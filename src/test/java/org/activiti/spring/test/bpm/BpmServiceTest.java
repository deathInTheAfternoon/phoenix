...
import org.activiti.spring.test.bpm.*;
...
@ContextConfiguration("classpath:org/activiti/spring/test/bpm/beans.xml")
public class BpmServiceTest {
  ...
  @Test
  //@Deployment(resources = {"org/activiti/spring/test/bpm/BpmServiceTest.testSimpleProcess.bpmn20.xml"})

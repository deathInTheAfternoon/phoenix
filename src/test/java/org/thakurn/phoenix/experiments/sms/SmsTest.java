...
@ContextConfiguration("classpath:org.thakurn.phoenix.experiments/sms/beans.xml")
public class SmsTest {
  /*@Autowired
  private MemberBpmService bpm;*/
  final Logger logger = LoggerFactory.getLogger(SmsTest.class);
  ...
  public void testSmsProcess() {
    ...
    runtimeService.startProcessInstanceByKey("sms_process", vars);
  }
}

...
import org.thakurn.phoenix.experiments.components.ProcessInitiatingPojo;
	...
	public void before() throws Throwable {
	  this.repositoryService = this.processEngine.getRepositoryService();
		...
		repositoryService.createDeployment()
		  .addClasspathResource("org.thakurn.phoenix.experiments/autodeployment/autodeploy.b.bpmn20.xml")
		  .addClasspathResource("org.thakurn.phoenix.experiments/components/waiter.bpmn20.xml")
		  .addClasspathResource("org.thakurn.phoenix.experiments/components/spring-component-waiter.bpmn20.xml")
		  .deploy();
	}

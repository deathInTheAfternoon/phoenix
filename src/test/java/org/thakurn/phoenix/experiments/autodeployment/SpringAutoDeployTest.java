...
package org.thakurn.phoenix.experiments.autodeployment;
...
@Ignore
 public class SpringAutoDeployTest extends PvmTestCase {
  ...
  protected static final String CTX_PATH 
    = "org.thakurn.phoenix.experiments/autodeployment/SpringAutoDeployTest-context.xml";
  protected static final String CTX_NO_DROP_PATH 
    = "org.thakurn.phoenix.experiments/autodeployment/SpringAutoDeployTest-no-drop-context.xml";
  protected static final String CTX_CREATE_DROP_CLEAN_DB 
    = "org.thakurn.phoenix.experiments/autodeployment/SpringAutoDeployTest-create-drop-clean-db-context.xml";
  ...
  public void testBasicActivitiSpringIntegration() {
    createAppContext("org.thakurn.phoenix.experiments/autodeployment/SpringAutoDeployTest-context.xml");
  ...
  public void testResourceRedeploymentAfterProcessDefinitionChange() throws Exception {
    ...
    String filePath = "org.thakurn.phoenix.experiments/autodeployment/autodeploy.a.bpmn20.xml";
